...
<div style="background-color: #ff9800; color: #000; text-align: center; padding: 15px; font-weight: bold; font-family: var(--font); position: sticky; top: 0; z-index: 9999;"> 
  🚧 https://hire.alec.today/ is under construction. Please visit my <a href="https://www.linkedin.com/in/alectronic0" style="color: #000; text-decoration: underline;">LinkedIn</a> for now. 🚧 
</div> 
...
<footer id="footer">
  <div class="container">
    <p>&copy; <span class="year"></span> Alec &middot; hire.alec.today &middot; All rights reserved. &middot; <a href="mailto:alec@alectronic.co">alec@alectronic.co</a> &middot; <button type="button" data-cc="show-preferencesModal" style="background:none;border:none;color:inherit;text-decoration:underline;cursor:pointer;font:inherit;padding:0;">Cookie Preferences 🍪</button></p>
